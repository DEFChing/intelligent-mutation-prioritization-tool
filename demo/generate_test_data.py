...
def generate_bug_history() -> dict:
    ...
    for i in range(30):
        bug = {
            ...
            "date_fixed": (datetime.now() - timedelta(days=random.randint(0, 30))).isoformat()
        }
        bugs.append(bug)
...
def main():
    ...
    print(f"   ✓ Generated {len(all_mutants)} mutants (including {len(duplicates)} intentional duplicates)")
...
- **historical_data.json**: Historical effectiveness rates for mutation operators
